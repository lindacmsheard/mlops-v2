...
git_folder_location='/home/lisheard/cmd/mlopsv2root'   #replace with the local root folder location where you want to create the project folder
project_name=mlopsv2-intro   #replace with your project name
github_org_name=lindacmsheard   #replace with your github org name
project_template_github_url=git@github.com:lindacmsheard/mlops-project-template.git # https://github.com/lindacmsheard/mlops-project-template   #replace with the url for the project template for your organization created in step 2.2, or leave for demo purposes
